...
// myTaskTests
const MyTaskTests = React.lazy(() => import("../components/task/Tests/Tests"));

// myTaskCultures
const MyTaskCultures = React.lazy(
  () => import("../components/task/Cultures/Cultures")
);

// myTaskCultureOptions
const MyTaskCultureOptions = React.lazy(
...
// myTaskCultureOptions
const MyTaskDoctors = React.lazy(
  () => import("../components/task/Doctors/Doctors")
);

// myTaskCultureOptions
const MyTaskTestCreate = React.lazy(
...
const uiRoutes: RoutesProps = {
  ...
  children: [
    ...
    {
      path: "/components/myTaskTests",
      name: "UIElements",
      element: <MyTaskTests></MyTaskTests>,
    },
    {
      path: "/components/myTaskCultures",
      name: "UIElements",
      element: <MyTaskCultures></MyTaskCultures>,
    },
    {
    ...
    {
      path: "/components/myTaskDoctors",
      name: "UIElements",
      element: <MyTaskDoctors></MyTaskDoctors>,
    },
    {
